...
<div class="flex flex-col gap-4 p-3">
  {#if masteryUnlocked}
  <div>
    <h3 class="mb-2 text-sm font-semibold text-amber-400">Mastery</h3>
    <div class="flex flex-col gap-2">
      {#each GLOBAL_UPGRADES as upgrade (upgrade.id)}
        ...
        <div
          class="flex items-center justify-between gap-2 rounded-md border border-amber-400/30 bg-amber-400/5 px-3 py-2 text-sm"
        >
          <div>
