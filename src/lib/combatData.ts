...
const UNIT_LIST: UnitDef[] = [
  ...
  u("wolf-rider", "Wolf Rider", "barbarian", 2, 25, 5, 3, 13, "melee", ["assassin", "charger"]),
  u("orc", "Orc", "barbarian", 3, 38, 7, 5, 10, "melee", ["brawler", "striker"]),
  u("ogre", "Ogre", "barbarian", 4, 69, 10, 7, 9, "melee", ["brawler", "tank"]),
  u("ram-rider", "Ram Rider", "barbarian", 4, 57, 10, 6, 10, "melee", ["controller", "disruptor"]),
  u("cyclops", "Cyclops", "barbarian", 5, 102, 16, 10, 10, "ranged", ["artillery", "bruiser"]),
  u("thunderbird", "Thunderbird", "barbarian", 5, 134, 18, 11, 14, "ranged", ["charger", "striker"]),
  u("behemoth", "Behemoth", "barbarian", 5, 277, 28, 17, 9, "melee", ["tank", "disruptor", "ascendant"]),
  // Knight
  u("peasant", "Peasant", "knight", 1, 9, 1, 1, 9, "melee", ["swarm", "defender"]),
  u("archer", "Archer", "knight", 2, 17, 6, 3, 9, "ranged", ["ranger", "artillery"]),
  u("griffin", "Griffin", "knight", 3, 32, 8, 8, 14, "melee", ["defender", "skirmisher"]),
  u("standard-bearer", "Standard Bearer", "knight", 3, 33, 6, 8, 9, "melee", ["support", "defender"]),
  u("swordsman", "Swordsman", "knight", 4, 51, 10, 12, 8, "melee", ["brawler", "defender"]),
  u("monk", "Monk", "knight", 5, 88, 14, 8, 9, "magic", ["support", "sustainer"]),
  u("cavalier", "Cavalier", "knight", 5, 100, 15, 15, 11, "melee", ["charger", "brawler"]),
  u("champion", "Champion", "knight", 5, 158, 24, 24, 12, "melee", ["charger", "executioner", "ascendant"]),
  // Wizard
  u("gremlin", "Gremlin", "wizard", 1, 4, 2, 2, 9, "ranged", ["support", "swarm"]),
  u("stone-golem", "Stone Golem", "wizard", 2, 43, 4, 8, 6, "melee", ["tank", "defender"]),
  u("mage", "Mage", "wizard", 3, 27, 10, 4, 9, "magic", ["ranger", "striker"]),
  u("bilehorn", "Bilehorn", "wizard", 4, 64, 10, 9, 8, "melee", ["bruiser", "disruptor"]),
  u("naga", "Naga", "wizard", 5, 104, 15, 12, 11, "melee", ["brawler", "bruiser"]),
  u("siege-golem", "Siege Golem", "wizard", 5, 117, 12, 12, 7, "ranged", ["tank", "artillery"]),
  u("giant", "Giant", "wizard", 5, 164, 18, 15, 8, "ranged", ["artillery", "executioner"]),
  u("titan", "Titan", "wizard", 5, 277, 27, 22, 11, "magic", ["artillery", "striker", "ascendant"]),
  // Necromancer
  ...
  u("black-knight", "Black Knight", "necromancer", 5, 113, 17, 14, 9, "melee", ["bruiser", "executioner"]),
  u("bone-dragon", "Bone Dragon", "necromancer", 5, 246, 27, 19, 10, "magic", ["tank", "disruptor", "ascendant"]),
  // Ranger
  u("sprite", "Sprite", "ranger", 1, 4, 2, 2, 12, "magic", ["skirmisher", "swarm"]),
  u("wood-elf", "Wood Elf", "ranger", 2, 15, 7, 3, 9, "ranged", ["ranger", "skirmisher"]),
  u("outrider", "Outrider", "ranger", 2, 22, 5, 4, 12, "melee", ["charger", "skirmisher"]),
  u("dendroid", "Dendroid", "ranger", 3, 49, 6, 11, 6, "melee", ["tank", "controller"]),
  u("pegasus", "Pegasus", "ranger", 4, 41, 10, 10, 12, "melee", ["assassin", "skirmisher"]),
  u("grand-elf", "Grand Elf", "ranger", 5, 70, 16, 11, 9, "ranged", ["ranger", "striker"]),
  u("battle-dwarf", "Battle Dwarf", "ranger", 5, 101, 14, 16, 8, "melee", ["bruiser", "executioner"]),
  u("unicorn", "Unicorn", "ranger", 5, 200, 24, 20, 11, "magic", ["striker", "controller", "ascendant"]),
  // Demon
  ...
  u("efreet", "Efreet", "demon", 5, 107, 18, 12, 11, "magic", ["skirmisher", "striker"]),
  u("devil", "Devil", "demon", 5, 215, 30, 22, 13, "magic", ["assassin", "executioner", "ascendant"]),
];
