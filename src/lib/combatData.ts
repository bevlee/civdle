...
const UNIT_LIST: UnitDef[] = [
  // Barbarian
  u("goblin", "Goblin", "barbarian", 1, 6, 2, 1, 11, "melee", ["swarm", "brawler"]),
  u("wolf-rider", "Wolf Rider", "barbarian", 2, 28, 5, 2, 13, "melee", ["assassin", "charger"]),
  u("orc", "Orc", "barbarian", 3, 41, 7, 4, 10, "melee", ["brawler", "striker"]),
  u("ogre", "Ogre", "barbarian", 4, 72, 10, 6, 9, "melee", ["brawler", "tank"]),
  u("ram-rider", "Ram Rider", "barbarian", 4, 60, 10, 5, 10, "melee", ["controller", "disruptor"]),
  u("cyclops", "Cyclops", "barbarian", 5, 105, 16, 9, 10, "ranged", ["artillery", "bruiser"]),
  u("thunderbird", "Thunderbird", "barbarian", 5, 132, 19, 10, 14, "ranged", ["charger", "striker"]),
  u("behemoth", "Behemoth", "barbarian", 5, 275, 29, 16, 9, "melee", ["tank", "disruptor", "ascendant"]),
  // Knight
  u("peasant", "Peasant", "knight", 1, 9, 1, 1, 9, "melee", ["swarm", "defender"]),
  u("archer", "Archer", "knight", 2, 20, 6, 2, 9, "ranged", ["ranger", "artillery"]),
  u("griffin", "Griffin", "knight", 3, 32, 8, 8, 14, "melee", ["defender", "skirmisher"]),
  u("standard-bearer", "Standard Bearer", "knight", 3, 38, 5, 8, 9, "melee", ["support", "defender"]),
  u("swordsman", "Swordsman", "knight", 4, 48, 10, 13, 8, "melee", ["brawler", "defender"]),
  u("monk", "Monk", "knight", 5, 99, 13, 6, 9, "magic", ["support", "sustainer"]),
  u("cavalier", "Cavalier", "knight", 5, 97, 15, 16, 11, "melee", ["charger", "brawler"]),
  u("champion", "Champion", "knight", 5, 160, 23, 25, 12, "melee", ["charger", "executioner", "ascendant"]),
  // Wizard
  u("gremlin", "Gremlin", "wizard", 1, 4, 2, 2, 9, "ranged", ["support", "swarm"]),
  u("stone-golem", "Stone Golem", "wizard", 2, 45, 3, 9, 6, "melee", ["tank", "defender"]),
  u("mage", "Mage", "wizard", 3, 25, 11, 3, 9, "magic", ["ranger", "striker"]),
  u("bilehorn", "Bilehorn", "wizard", 4, 64, 10, 9, 8, "melee", ["bruiser", "disruptor"]),
  u("naga", "Naga", "wizard", 5, 104, 15, 12, 11, "melee", ["brawler", "bruiser"]),
  u("siege-golem", "Siege Golem", "wizard", 5, 127, 10, 12, 7, "ranged", ["tank", "artillery"]),
  u("giant", "Giant", "wizard", 5, 156, 19, 16, 8, "ranged", ["artillery", "executioner"]),
  u("titan", "Titan", "wizard", 5, 274, 27, 23, 11, "magic", ["artillery", "striker", "ascendant"]),
  // Necromancer
  u("skeleton", "Skeleton", "necromancer", 1, 2, 3, 3, 8, "melee", ["swarm", "brawler"]),
  u("zombie", "Zombie", "necromancer", 2, 27, 5, 5, 6, "melee", ["tank", "controller"]),
  u("ghost", "Ghost", "necromancer", 3, 19, 8, 8, 10, "magic", ["skirmisher", "disruptor"]),
  u("blood-acolyte", "Blood Acolyte", "necromancer", 3, 33, 7, 6, 9, "magic", ["sustainer", "support"]),
  u("vampire", "Vampire", "necromancer", 4, 55, 10, 9, 9, "melee", ["assassin", "sustainer"]),
  u("lich", "Lich", "necromancer", 5, 76, 15, 12, 9, "magic", ["ranger", "controller"]),
  u("black-knight", "Black Knight", "necromancer", 5, 110, 17, 15, 9, "melee", ["bruiser", "executioner"]),
  u("bone-dragon", "Bone Dragon", "necromancer", 5, 249, 27, 18, 10, "magic", ["tank", "disruptor", "ascendant"]),
  // Ranger
  u("sprite", "Sprite", "ranger", 1, 4, 2, 2, 12, "magic", ["skirmisher", "swarm"]),
  u("wood-elf", "Wood Elf", "ranger", 2, 13, 8, 2, 9, "ranged", ["ranger", "skirmisher"]),
  u("outrider", "Outrider", "ranger", 2, 22, 5, 4, 12, "melee", ["charger", "skirmisher"]),
  u("dendroid", "Dendroid", "ranger", 3, 48, 5, 13, 6, "melee", ["tank", "controller"]),
  u("pegasus", "Pegasus", "ranger", 4, 38, 10, 11, 12, "melee", ["assassin", "skirmisher"]),
  u("grand-elf", "Grand Elf", "ranger", 5, 73, 16, 10, 9, "ranged", ["ranger", "striker"]),
  u("battle-dwarf", "Battle Dwarf", "ranger", 5, 103, 13, 17, 8, "melee", ["bruiser", "executioner"]),
  u("unicorn", "Unicorn", "ranger", 5, 205, 23, 20, 11, "magic", ["striker", "controller", "ascendant"]),
  // Demon
  u("imp", "Imp", "demon", 1, 3, 3, 2, 10, "ranged", ["swarm", "disruptor"]),
  u("gog", "Gog", "demon", 2, 22, 6, 4, 9, "ranged", ["ranger", "artillery"]),
  u("hell-hound", "Hell Hound", "demon", 3, 24, 10, 6, 12, "melee", ["striker", "charger"]),
  u("demon", "Demon", "demon", 4, 57, 11, 8, 9, "melee", ["brawler", "sustainer"]),
  u("blood-fiend", "Blood Fiend", "demon", 4, 57, 10, 8, 10, "melee", ["sustainer", "bruiser"]),
  u("pit-fiend", "Pit Fiend", "demon", 5, 83, 17, 13, 9, "magic", ["support", "bruiser"]),
  u("efreet", "Efreet", "demon", 5, 102, 19, 12, 11, "magic", ["skirmisher", "striker"]),
  u("devil", "Devil", "demon", 5, 207, 31, 23, 13, "magic", ["assassin", "executioner", "ascendant"]),
];
