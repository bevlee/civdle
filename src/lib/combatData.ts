...
const UNIT_LIST: UnitDef[] = [
  // Barbarian
  u("goblin", "Goblin", "barbarian", 1, 7, 2, 1, 11, "melee", ["swarm", "brawler"]),
  u("wolf-rider", "Wolf Rider", "barbarian", 2, 21, 5, 3, 13, "melee", ["assassin", "charger"]),
  u("orc", "Orc", "barbarian", 3, 37, 8, 5, 10, "melee", ["brawler", "striker"]),
  u("ogre", "Ogre", "barbarian", 4, 72, 9, 6, 9, "melee", ["brawler", "tank"]),
  u("ram-rider", "Ram Rider", "barbarian", 4, 59, 10, 7, 10, "melee", ["controller", "disruptor"]),
  u("cyclops", "Cyclops", "barbarian", 5, 105, 16, 11, 10, "ranged", ["artillery", "bruiser"]),
  u("thunderbird", "Thunderbird", "barbarian", 5, 98, 13, 8, 14, "ranged", ["charger", "striker"]),
  u("behemoth", "Behemoth", "barbarian", 5, 271, 27, 16, 9, "melee", ["tank", "disruptor", "ascendant"]),
  // Knight
  u("peasant", "Peasant", "knight", 1, 6, 2, 2, 9, "melee", ["swarm", "defender"]),
  u("archer", "Archer", "knight", 2, 17, 7, 4, 9, "ranged", ["ranger", "artillery"]),
  u("griffin", "Griffin", "knight", 3, 31, 6, 6, 14, "melee", ["defender", "skirmisher"]),
  u("standard-bearer", "Standard Bearer", "knight", 3, 33, 7, 9, 9, "melee", ["support", "defender"]),
  u("swordsman", "Swordsman", "knight", 4, 53, 10, 12, 8, "melee", ["brawler", "defender"]),
  u("monk", "Monk", "knight", 5, 106, 18, 10, 9, "magic", ["support", "sustainer"]),
  u("cavalier", "Cavalier", "knight", 5, 98, 14, 14, 11, "melee", ["charger", "brawler"]),
  u("champion", "Champion", "knight", 5, 185, 28, 28, 12, "melee", ["charger", "executioner", "ascendant"]),
  // Wizard
  u("gremlin", "Gremlin", "wizard", 1, 6, 2, 2, 9, "ranged", ["support", "swarm"]),
  u("stone-golem", "Stone Golem", "wizard", 2, 35, 3, 7, 6, "melee", ["tank", "defender"]),
  u("mage", "Mage", "wizard", 3, 28, 11, 4, 9, "magic", ["ranger", "striker"]),
  u("bilehorn", "Bilehorn", "wizard", 4, 67, 9, 9, 8, "melee", ["bruiser", "disruptor"]),
  u("naga", "Naga", "wizard", 5, 99, 15, 12, 11, "melee", ["brawler", "bruiser"]),
  u("siege-golem", "Siege Golem", "wizard", 5, 129, 14, 14, 7, "ranged", ["tank", "artillery"]),
  u("giant", "Giant", "wizard", 5, 127, 14, 12, 8, "ranged", ["artillery", "executioner"]),
  u("titan", "Titan", "wizard", 5, 247, 24, 19, 11, "magic", ["artillery", "striker", "ascendant"]),
  // Necromancer
  u("skeleton", "Skeleton", "necromancer", 1, 6, 2, 2, 8, "melee", ["swarm", "brawler"]),
  u("zombie", "Zombie", "necromancer", 2, 31, 5, 5, 6, "melee", ["tank", "controller"]),
  u("ghost", "Ghost", "necromancer", 3, 28, 8, 8, 10, "magic", ["skirmisher", "disruptor"]),
  u("blood-acolyte", "Blood Acolyte", "necromancer", 3, 34, 8, 7, 9, "magic", ["sustainer", "support"]),
  u("vampire", "Vampire", "necromancer", 4, 58, 10, 9, 9, "melee", ["assassin", "sustainer"]),
  u("lich", "Lich", "necromancer", 5, 94, 18, 14, 9, "magic", ["ranger", "controller"]),
  u("black-knight", "Black Knight", "necromancer", 5, 107, 16, 13, 9, "melee", ["bruiser", "executioner"]),
  u("bone-dragon", "Bone Dragon", "necromancer", 5, 244, 27, 20, 10, "magic", ["tank", "disruptor", "ascendant"]),
  // Ranger
  u("sprite", "Sprite", "ranger", 1, 3, 2, 2, 12, "magic", ["skirmisher", "swarm"]),
  u("wood-elf", "Wood Elf", "ranger", 2, 17, 7, 4, 9, "ranged", ["ranger", "skirmisher"]),
  u("outrider", "Outrider", "ranger", 2, 21, 5, 4, 12, "melee", ["charger", "skirmisher"]),
  u("dendroid", "Dendroid", "ranger", 3, 44, 6, 10, 6, "melee", ["tank", "controller"]),
  u("pegasus", "Pegasus", "ranger", 4, 41, 10, 10, 12, "melee", ["assassin", "skirmisher"]),
  u("grand-elf", "Grand Elf", "ranger", 5, 92, 19, 13, 9, "ranged", ["ranger", "striker"]),
  u("battle-dwarf", "Battle Dwarf", "ranger", 5, 107, 15, 17, 8, "melee", ["bruiser", "executioner"]),
  ...
  u("hell-hound", "Hell Hound", "demon", 3, 30, 8, 5, 12, "melee", ["striker", "charger"]),
  u("demon", "Demon", "demon", 4, 56, 11, 8, 9, "melee", ["brawler", "sustainer"]),
  u("blood-fiend", "Blood Fiend", "demon", 4, 56, 10, 8, 10, "melee", ["sustainer", "bruiser"]),
  u("pit-fiend", "Pit Fiend", "demon", 5, 94, 18, 14, 9, "magic", ["support", "bruiser"]),
  u("efreet", "Efreet", "demon", 5, 97, 16, 11, 11, "magic", ["skirmisher", "striker"]),
  u("devil", "Devil", "demon", 5, 199, 27, 20, 13, "magic", ["assassin", "executioner", "ascendant"]),
];
